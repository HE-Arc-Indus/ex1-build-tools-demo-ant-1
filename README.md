...
___Pour tester si la version installée fonctionne correctement, lancer la commande : ANT -version___
...
name : ___nom du projet___     
default : ___cible utilisée par défault si rien n'est spécifié___     
basedir : ___dossier racine de base utilisé pour l'exécution des commandes___   
